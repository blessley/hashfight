...
timings_OUT_DIR="/glade/work/shaomeng/v100/hashfight/results/Oct02-1" #dir for output timing files
...
failure='0'
#: <<'COMMENT'
printf "CONFIG: $factors load factor, $failure-10 failure rate, variable number of pairs\n" 
...
for l in $factors; do #load factors
  for f in $failure; do #failure rates
    ...
    for k in {850000000..900000000..50000000}; do #num key-val pairs
