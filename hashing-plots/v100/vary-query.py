...
canvas = toyplot.Canvas('3.85in', '6in')

#Plot 2: K40 Queries
algos = {"hfQuery10":0, "cuQuery10":1, "thSearch10":2,
         "hfQuery11":3, "cuQuery11":4, "thSearch11":5}
legends = {"hfQuery10":"HashFight,1.03,0.5B", \
           "cuQuery10":"CUDPP,1.03,0.5B", \
           "thSearch10":"Thrust-Search,0.5B", \
           "hfQuery11":"HashFight,1.5,0.4B", \
           "cuQuery11":"CUDPP,1.5,0.4B", \
           "thSearch11":"Thrust-Search,0.4B"}
...
legends = {"hfQuery00":"HashFight,1.03,1.45B", \
           "cuQuery00":"CUDPP,1.03,1.45B", \
           "thSearch00":"Thrust-Search,1.45B", \
           "hfQuery01":"HashFight,1.5,1.15B", \
           "cuQuery01":"CUDPP,1.5,1.15B", \
           "thSearch01":"Thrust-Search,1.15B"}
