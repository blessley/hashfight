...
#run the application:
${BIN}/Hashing_CUDA 50000000 1.03 0 10 0 ${data_DIR}
${BIN}/Hashing_CUDA 250000000 1.03 0 10 0 ${data_DIR}
${BIN}/Hashing_CUDA 500000000 1.03 0 10 0 ${data_DIR}
...
${BIN}/Hashing_CUDA 50000000 1.03 5 10 0 ${data_DIR}
${BIN}/Hashing_CUDA 500000000 1.03 5 10 0 ${data_DIR}
